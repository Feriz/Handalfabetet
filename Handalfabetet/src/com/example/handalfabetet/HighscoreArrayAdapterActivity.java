package com.example.handalfabetet;
 ...
 */
public class HighscoreArrayAdapterActivity extends ArrayAdapter<User> {

    private List<User> users;
    public LayoutInflater inflater;

    public HighscoreArrayAdapterActivity(Context context, int textViewResourceId,
	    List<User> users) {
	...
	View rowView = inflater.inflate(R.layout.activity_highscore_array_adapter, null);
